"""
Visualization script for 2024_fb_posts_president_scored_anon.csv using Pandas, Matplotlib, and Seaborn.
...
# Load dataset
DATASET = 'datasets_period_03_unzipped/2024_fb_posts_president_scored_anon.csv'
df = pd.read_csv(DATASET)

# Output directory for plots
PLOT_DIR = 'visualizations_fb_posts'
